...
export function WhyFluxgridMobile() {
  ...
  return (
    <div className="lg:hidden block px-6 py-16 space-y-24 bg-background overflow-hidden relative">
       {/* Background Noise for mobile */}
       <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{ backgroundImage: "url('data:image/svg+xml,%3Csvg viewBox=\"0 0 200 200\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cfilter id=\"noiseFilter\"%3E%3CfeTurbulence type=\"fractalNoise\" baseFrequency=\"0.65\" numOctaves=\"3\" stitchTiles=\"stitch\"/%3E%3C/filter%3E%3Crect width=\"100%25\" height=\"100%25\" filter=\"url(%23noiseFilter)\"/%3E%3C/svg%3E')" }} />

       <div className="space-y-8 relative">
          <div className="w-16 h-px bg-accent" />
          <h2 className="text-6xl font-bold font-display italic tracking-tighter leading-tight">Built for <span className="text-accent underline decoration-accent/20">Scale.</span></h2>
